...
PIN_TOOL = os.environ['PIN_ROOT'] + "/source/tools/sh_trace/obj-intel64/aurora_tracer.so"

ASAN_OPTIONS = "ASAN_OPTIONS=detect_leaks=0"

TMP_PATH = "/tmp/tm/" # Default: "/tmp/tm/"
PIN_TIMEOUT = 5 * 60 # Default: 5 * 60
PARALLEL_PROCESSES = os.cpu_count() # Default: os.cpu_count()

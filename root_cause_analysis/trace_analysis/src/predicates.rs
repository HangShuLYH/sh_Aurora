...
impl SerializedPredicate {
    pub fn new(name: String, address: (usize, usize), score: f64) -> SerializedPredicate {
        SerializedPredicate {
            name,
            score,
            address,
    ...
    pub fn to_string(&self) -> String {
        format!("{:#018x} -- {} -- {} -- {}", self.address.0, self.address.1 , self.name, self.score)
    }
...
impl Predicate {
    ...
    pub fn gen_empty(address: (usize, usize)) -> Predicate {
